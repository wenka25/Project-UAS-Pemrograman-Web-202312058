...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-semibold mb-1">Create New Category</h2>
            <p class="text-muted small">Add a new product category to your store</p>
        </div>
            ...
            <form method="POST">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" rows="3" class="form-control rounded-2" 
